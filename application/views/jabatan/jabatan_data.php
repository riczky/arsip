              ...
              <?php foreach($row->result_array() as $key => $data) : ?>
                <tr>
                  ...
                  <td class="text-center" width="160px">
                    ...
                    <form action="<?=site_url('jabatan/del') ?>" method="post">
	                     
                       <a href="<?=site_url('jabatan/edit/'. $data['id_jabatan']);?>" class="btn btn-warning btn-xs"> 
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                	<label>Jabatan</label>
                	<input type="text" class="form-control" name="nama_jabatan" placeholder="Jabatan" required>
                </div>
